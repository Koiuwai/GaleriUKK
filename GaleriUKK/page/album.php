                ...
                <div class="card-body">
                    ...
                    <?php if(!isset($_GET['edit'])): ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_album" class="form-control"
                            required cols="30" rows="5"></textarea>
                        </div>
                        <small class="text-info">File Harus Berupa: *.jpg, *.png, *.gif</small>
                        <input type="submit" value="Simpan" name="submit" class="btn btn-info my-3 ">
                    </form>
                    <?php elseif(isset($_GET['edit'])): ?>
                        <form action="?url=album&&edit&&albumid=<?= $val['AlbumID'] ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Nama Album</label>
                        ...
                        <div class="form-group">
                            <label>Deskripsi Album</label>
                            <textarea name="deskripsi_album" class="form-control"
                            required cols="30" rows="5"><?= $val['Deskripsi'] ?></textarea>
                        </div>
                        <small class="text-info">File Harus Berupa: *.jpg, *.png, *.gif</small>
